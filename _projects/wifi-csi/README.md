...
**Zero toolboxes used.** This project relies entirely on pure matrix mathematics, making it highly portable to hardware constraints like microcontrollers or edge gateways.
...
4. **Feature Extraction:** Calculates rolling standard deviation using a sliding 200ms time-window to isolate signal variance.
5. **Thresholding & Decision Engine:** Runs an automated binary check against an empirical threshold ($1.0$) to flag real-time intrusions.
...
*(Replace this text with a screenshot/GIF of your generated MATLAB plot window!)*
...
fprintf('====================================================\n');
🚀 How to Execute
Ensure you have base MATLAB installed (compatible with versions R2018a through current releases). No external packages required.

Download or clone this workspace.

Open MATLAB and navigate to the project directory.

Run the file by clicking Run or entering the following command in the Command Window:
